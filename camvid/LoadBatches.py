...
if __name__ == '__main__':
    G = imageSegmentationGenerator("D:\FCN\data\SegNet-Tutorial-master\CamVid\\test\\",
                                   "D:\FCN\data\SegNet-Tutorial-master\CamVid\\testannot\\", batch_size=16, n_classes=11, input_height=320, input_width=320)
    x, y = G.__next__()
